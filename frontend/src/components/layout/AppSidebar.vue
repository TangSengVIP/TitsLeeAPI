<template>
  ...
  >
    ...
    <div class="sidebar-header">
      ...
      <div class="flex h-9 max-h-9 w-auto max-w-[160px] items-center justify-center overflow-hidden rounded-xl shadow-glow">
        <img
          v-if="settingsLoaded"
          :src="siteLogo || '/logo.png'"
          alt="Logo"
          class="max-h-9 w-auto max-w-full object-contain object-left"
        />
      </div>
      <transition name="fade">
        <div v-if="!sidebarCollapsed" class="flex flex-col">
          <span
            class="bg-gradient-to-r from-white via-[#e0fffa] to-[#5eead4] bg-clip-text text-lg font-bold tracking-tight text-transparent"
          >
            {{ siteName }}
          </span>
          <!-- Version Badge -->
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-gray-100 p-3 dark:border-white/[0.06]">
      <!-- Collapse Button -->
      <button
        @click="toggleSidebar"
